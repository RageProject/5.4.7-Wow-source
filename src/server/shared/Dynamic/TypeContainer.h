...
{
    public:
        template<class SPECIFIC_TYPE> size_t Count() const { return TrinityCore::Count(i_elements, (SPECIFIC_TYPE*)NULL); }

        /// inserts a specific object into the container
        template<class SPECIFIC_TYPE> bool insert(SPECIFIC_TYPE *obj)
        {
            SPECIFIC_TYPE* t = TrinityCore::Insert(i_elements, obj);
            return (t != NULL);
        }
        ...
        //{
        //    SPECIFIC_TYPE* t = TrinityCore::Remove(i_elements, obj);
        //    return (t != NULL);
        //}
