...
void WorldSession::HandleMovementOpcodes(WorldPacket& recvPacket)
{
    ...
    if (movementInfo.t_guid)
    {
        ...
        if (!TrinityCore::IsValidMapCoord(movementInfo.pos.GetPositionX() + movementInfo.t_pos.GetPositionX(), movementInfo.pos.GetPositionY() + movementInfo.t_pos.GetPositionY(),
