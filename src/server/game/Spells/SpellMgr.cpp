        ...
        ///////////////////////////
            ...
            case 99234:
				...
				case 113792:// Pyschic Horror - Psyfiend
					spellInfo->MaxAffectedTargets = 1;
					spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(216); // 1.9seconds zzz
           ...
           case 42471: // Hatch Eggs
            ...
            // TODO: if its needed: Spells which update last tick (only one tick)
            /*switch (spellInfo->Id)
            {
