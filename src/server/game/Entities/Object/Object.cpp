...
void Position::MovePosition(Position &pos, float dist, float angle, WorldObject* object)
{
    ...
    if (!TrinityCore::IsValidMapCoord(destx, desty))
    {
    ...
    TrinityCore::NormalizeMapCoord(pos.m_positionX);
    TrinityCore::NormalizeMapCoord(pos.m_positionY);
...
void WorldObject::GetRandomPoint(const Position &pos, float distance, float &rand_x, float &rand_y, float &rand_z) const
{
    ...
    TrinityCore::NormalizeMapCoord(rand_x);
    TrinityCore::NormalizeMapCoord(rand_y);
...
{
    return TrinityCore::IsValidMapCoord(m_positionX, m_positionY, m_positionZ, m_orientation);
}
...
void WorldObject::MonsterSay(const char* text, uint32 language, uint64 TargetGuid)
{
    ...
    TrinityCore::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, text, language, TargetGuid);
    TrinityCore::LocalizedPacketDo<TrinityCore::MonsterCustomChatBuilder> say_do(say_build);
    TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterSay(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    TrinityCore::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, textId, language, TargetGuid);
    TrinityCore::LocalizedPacketDo<TrinityCore::MonsterChatBuilder> say_do(say_build);
    TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY));
}
...
void WorldObject::MonsterYell(const char* text, uint32 language, uint64 TargetGuid)
{
    ...
    TrinityCore::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, text, language, TargetGuid);
    TrinityCore::LocalizedPacketDo<TrinityCore::MonsterCustomChatBuilder> say_do(say_build);
    TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterYell(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    TrinityCore::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, textId, language, TargetGuid);
    TrinityCore::LocalizedPacketDo<TrinityCore::MonsterChatBuilder> say_do(say_build);
    TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL));
}
...
void WorldObject::MonsterTextEmote(int32 textId, uint64 TargetGuid, bool IsBossEmote)
{
    ...
    TrinityCore::MonsterChatBuilder say_build(*this, IsBossEmote ? CHAT_MSG_RAID_BOSS_EMOTE : CHAT_MSG_MONSTER_EMOTE, textId, LANG_UNIVERSAL, TargetGuid);
    TrinityCore::LocalizedPacketDo<TrinityCore::MonsterChatBuilder> say_do(say_build);
    TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE), say_do);
    TypeContainerVisitor<TrinityCore::PlayerDistWorker<TrinityCore::LocalizedPacketDo<TrinityCore::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
Creature* WorldObject::FindNearestCreature(uint32 entry, float range, bool alive) const
{
    ...
    TrinityCore::NearestCreatureEntryWithLiveStateInObjectRangeCheck checker(*this, entry, alive, range);
    TrinityCore::CreatureLastSearcher<TrinityCore::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(this, creature, checker);
...
{
    GameObject* go = NULL;
    TrinityCore::NearestGameObjectEntryInObjectRangeCheck checker(*this, entry, range);
    TrinityCore::GameObjectLastSearcher<TrinityCore::NearestGameObjectEntryInObjectRangeCheck> searcher(this, go, checker);
...
{ 
    GameObject* go = NULL;
    TrinityCore::NearestGameObjectTypeInObjectRangeCheck checker(*this, type, range);
    TrinityCore::GameObjectLastSearcher<TrinityCore::NearestGameObjectTypeInObjectRangeCheck> searcher(this, go, checker);
    VisitNearbyGridObject(range, searcher);
    return go;
}
...
{
    Player* player = NULL;
    TrinityCore::AnyPlayerInObjectRangeCheck check(this, range);
    TrinityCore::PlayerSearcher<TrinityCore::AnyPlayerInObjectRangeCheck> searcher(this, player, check);
...
{
    CellCoord pair(TrinityCore::ComputeCellCoord(this->GetPositionX(), this->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

    TrinityCore::AllGameObjectsWithEntryInRange check(this, entry, maxSearchRange);
    TrinityCore::GameObjectListSearcher<TrinityCore::AllGameObjectsWithEntryInRange> searcher(this, gameobjectList, check);
    TypeContainerVisitor<TrinityCore::GameObjectListSearcher<TrinityCore::AllGameObjectsWithEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetCreatureListWithEntryInGrid(std::list<Creature*>& creatureList, uint32 entry, float maxSearchRange) const
{
    ...
    TrinityCore::AllCreaturesOfEntryInRange check(this, entry, maxSearchRange);
    TrinityCore::CreatureListSearcher<TrinityCore::AllCreaturesOfEntryInRange> searcher(this, creatureList, check);
    TypeContainerVisitor<TrinityCore::CreatureListSearcher<TrinityCore::AllCreaturesOfEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
{    
    TrinityCore::AnyPlayerInObjectRangeCheck checker(this, maxSearchRange);
    TrinityCore::PlayerListSearcher<TrinityCore::AnyPlayerInObjectRangeCheck> searcher(this, playerList, checker);
...
void WorldObject::GetNearPoint2D(float &x, float &y, float distance2d, float absAngle) const
{
    ...
    TrinityCore::NormalizeMapCoord(x);
    TrinityCore::NormalizeMapCoord(y);
}
...
void WorldObject::GetNearPoint(WorldObject const* searcher, float &x, float &y, float &z, float searcher_size, float distance2d, float absAngle) const
{
    ...
    // adding used positions around object
    {
        ...
        TrinityCore::NearUsedPosDo u_do(*this, searcher, absAngle, selector);
        TrinityCore::WorldObjectWorker<TrinityCore::NearUsedPosDo> worker(this, u_do);

        TypeContainerVisitor<TrinityCore::WorldObjectWorker<TrinityCore::NearUsedPosDo>, GridTypeMapContainer  > grid_obj_worker(worker);
        TypeContainerVisitor<TrinityCore::WorldObjectWorker<TrinityCore::NearUsedPosDo>, WorldTypeMapContainer > world_obj_worker(worker);
...
void WorldObject::DestroyForNearbyPlayers()
{
    ...
    TrinityCore::AnyPlayerInObjectRangeCheck check(this, GetVisibilityRange(), false);
    TrinityCore::PlayerListSearcher<TrinityCore::AnyPlayerInObjectRangeCheck> searcher(this, targets, check);
...
void WorldObject::UpdateObjectVisibility(bool /*forced*/)
{
    ...
    TrinityCore::VisibleChangesNotifier notifier(*this);
    VisitNearbyWorldObject(GetVisibilityRange(), notifier);
}
