        ...
        struct npc_crok_scourgebaneAI : public npc_escortAI
        {
            ...
            void WaypointStart(uint32 waypointId)
            {
                ...
                switch (waypointId)
                {
                    ...
                    case 4:
                    {
                        ...
                        TrinityCore::CreatureListSearcher<FrostwingVrykulSearcher> searcher(me, temp, check);
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage)
            {
                ...
                if (!_wipeCheckTimer)
                {
                    _wipeCheckTimer = 1000;
                    Player* player = NULL;
                    TrinityCore::AnyPlayerInObjectRangeCheck check(me, 60.0f);
                    TrinityCore::PlayerSearcher<TrinityCore::AnyPlayerInObjectRangeCheck> searcher(me, player, check);
                    ...
                    if (!player)
                    {
                        ...
                        if (damage >= me->GetHealth())
                        {
                            ...
                            TrinityCore::CreatureWorker<FrostwingGauntletRespawner> worker(me, respawner);
    ...
    public:
                ...
                while (uint32 eventId = Events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ARNATH_PW_SHIELD:
                        {
                            ...
                            DoCast(TrinityCore::Containers::SelectRandomContainerElement(targets), SPELL_POWER_WORD_SHIELD);
        ...
        private:
            Creature* FindFriendlyCreature() const
            {
                ...
                TrinityCore::MostHPMissingInRange u_check(me, 60.0f, 0);
                TrinityCore::CreatureLastSearcher<TrinityCore::MostHPMissingInRange> searcher(me, target, u_check);
    ...
    public:
        ...
        class spell_icc_sprit_alarm_SpellScript : public SpellScript
        {
            ...
            void HandleEvent(SpellEffIndex effIndex)
            {
                ...
                wards.sort(TrinityCore::ObjectDistanceOrderPred(GetCaster()));
    ...
    public:
        ...
        class spell_frost_giant_death_plague_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                if (!targets.empty())
                {
                    WorldObject* target = TrinityCore::Containers::SelectRandomContainerElement(targets);
                    targets.clear();
    ...
    public:
        ...
        class spell_svalna_revive_champion_SpellScript : public SpellScript
        {
            ...
            void RemoveAliveTarget(std::list<WorldObject*>& targets)
            {
                ...
                TrinityCore::RandomResizeList(targets, 2);
            }
    ...
    public:
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* /*areaTrigger*/)
        {
            ...
            if (instance->GetData(DATA_COLDFLAME_JETS) == NOT_STARTED)
            {
                ...
                traps.sort(TrinityCore::ObjectDistanceOrderPred(player));
                bool instant = false;
