    ...
    public:
        ...
        class spell_rog_shroud_of_concealment_SpellScript : public SpellScript
        {
            ...
            void SelectTargets(std::list<WorldObject*>& targets)
            {
                ...
                targets.remove_if(TrinityCore::UnitAuraCheck(true, BG_WS_SPELL_WARSONG_FLAG));
                targets.remove_if(TrinityCore::UnitAuraCheck(true, BG_WS_SPELL_SILVERWING_FLAG));
                targets.remove_if(TrinityCore::UnitAuraCheck(true, BG_KT_SPELL_ORB_PICKED_UP_1));
                targets.remove_if(TrinityCore::UnitAuraCheck(true, BG_KT_SPELL_ORB_PICKED_UP_2));
                targets.remove_if(TrinityCore::UnitAuraCheck(true, BG_KT_SPELL_ORB_PICKED_UP_3));
                targets.remove_if(TrinityCore::UnitAuraCheck(true, BG_KT_SPELL_ORB_PICKED_UP_4));
