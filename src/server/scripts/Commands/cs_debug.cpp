    ...
    public:
        ...
        static bool HandleDebugGuildEventCommand(ChatHandler* handler, char const* args)
        {
            ...
            switch (opcodeId)
            {
                case 0x20:
                {
                    // La migration de votre guilde est terminee. Rendez-vous sur [cette page Internet] pour de plus amples informations.
        ...
        static bool HandleDebugEnterVehicleCommand(ChatHandler* handler, char const* args)
        {
            ...
            else
            {
                ...
                TrinityCore::AllCreaturesOfEntryInRange check(handler->GetSession()->GetPlayer(), entry, 20.0f);
                TrinityCore::CreatureSearcher<TrinityCore::AllCreaturesOfEntryInRange> searcher(handler->GetSession()->GetPlayer(), passenger, check);
